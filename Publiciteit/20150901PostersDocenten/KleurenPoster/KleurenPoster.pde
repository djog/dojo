...
for (int z = 0; z < 5; z++){
  ...
  PFont head = createFont("Source Code Pro",30*2);
...
for (int i = 0; i < maxi; i++){
  ...
  textFont(bold);
  text(text[ 1],x,height/8+(3*32+0*26+0*16)*2-i);
  text(text[ 3],x,height/8+(4*32+1*26+1*16)*2-i);
  text(text[ 6],x,height/8+(5*32+2*26+3*16)*2-i);
  text(text[ 9],x,height/8+(6*32+3*26+5*16)*2-i);
  text(text[12],x,height/8+(7*32+3*26+7*16)*2-i);
  ...
  text(text[11],x,height/8+(6*32+4*26+6*16)*2+i);
  text(text[13],x,height/8+(7*32+5*26+7*16)*2+i);
  //text(text[14],x,height/8+(7*32+5*26+8*16)*2+i);
  
  
  textAlign(RIGHT,BOTTOM);
  text(text[14],width*7/8,height*7/8);
}
